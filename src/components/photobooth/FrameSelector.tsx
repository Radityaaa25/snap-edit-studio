...
import { Frame, Square, Sparkles, Sun } from 'lucide-react';

export type FrameType = 'none' | 'classic' | 'polaroid' | 'neon' | 'vintage';
      ...
      <div className="flex flex-wrap gap-2">
        {frames.map((frame) => (
          ...
          >
            ...
            <span className="text-xs font-medium text-foreground">{frame.name}</span>
          </button>
        ))}
      </div>
    </div>
